# twitch-anxiety-mod portfolio roadmap

## 90-day evidence snapshot
- Commits (90 days): 8
- Files changed (90 days): 29
- Last signal: 78409bd (4 days ago)
- Top modified areas: docs(10);00_agile(6);store-assets(3);scripts(2);popup.js(1);popup.html(1)
- Notes: clean_at_scan
...
- [ ] Document owner and intent for area: docs(10)
